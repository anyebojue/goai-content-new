      ...
      <div className={styles.container}>
                ...
                <div className={styles.demoBadgeRow}>
                  ...
                  <div className={styles.demoAlphaBadge}>
                    <div className={styles.demoAlphaIcon}>
                      <img
                        className={styles.demoAlphaIconImg}
                        src="/svg/diamond.svg"
                        width="14"
                        height="12"
                        alt=""
              ...
              <div className={styles.demoKeyDriversList}>
                <div className={styles.demoKeyDriverItem}>
                  ...
                  <div className={styles.demoKeyDriverContent}>
                    <div className={styles.demoKeyDriverName}>
                      Policy Support
                    </div>
                    <div className={styles.demoKeyDriverDesc}>
                      Benefiting from the United States&apos; &quot;Domestic
                      Supply&quot; policy, committed to establishing a rare
                      earth magnet supply chain in the United States.
                    </div>
                  </div>
                </div>
                <div className={styles.demoKeyDriverItem}>
                  ...
                  <div className={styles.demoKeyDriverContent}>
                    ...
                    <div className={styles.demoKeyDriverDesc}>
                      Utilize local reserves to meet the growing demand for
                      green energy (such as electric vehicles, wind turbines)
                      and defense needs.
                    </div>
                  </div>
                </div>
                <div className={styles.demoKeyDriverItem}>
                  ...
                  <div className={styles.demoKeyDriverContent}>
                    ...
                    <div className={styles.demoKeyDriverDesc}>
                      The United States has a strong &quot;moat&quot; in the
                      domestic rare earth extraction and magnet manufacturing
                      fields.
                    </div>
                  </div>
                </div>
        ...
        <div className={`${styles.featureRow} ${styles.reverse}`}>
          ...
          <div className={styles.featureText}>
            ...
            <p>
              We don&apos;t just show you &quot;VIX: 18.6&quot;. We show you
              what it means. Our app visualizes the data with intuitive gauges
              and provides a synthesized implication, so you understand the
              &quot;so what&quot; in seconds. Our GoAI Signals feed keeps you
              informed.
            </p>
          </div>
        </div>
        ...
        <div className={styles.featureRow}>
          ...
          <div className={styles.featureText}>
            ...
            <p>
              ...
              AI-generated probability of an earnings beat/miss and the key
              theme investors are watching, so you are prepared with our Event
              Analysis feed.
            </p>
          </div>
        </div>
